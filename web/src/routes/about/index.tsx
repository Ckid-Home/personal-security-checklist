  ...
  return (
    <div class="m-4 md:mx-16">
            ...
            onResolved={(contributors: Contributor[]) =>
              contributors.map((contributor: Contributor) => (
                ...
                >
                  ...
                  />
                  <p class="text-ellipsis overflow-hidden w-max-16 mx-auto line-clamp-2">
              ...
              contributors.map((contributor: Contributor) => (
                ...
                >
                  <img
                    ...
                    alt={contributor.login}
                  />
                  <p class="text-ellipsis overflow-hidden w-max-16 mx-auto">{contributor.login}</p>
                </a>
              ))
            }
          />
      ...
      <article class="bg-back p-8 mx-auto max-w-[1200px] my-8 rounded-lg shadow-md">
        <h2 class="text-3xl mb-2" id="author">
          About the Author
        </h2>
        <p>
          This project was originally started by me,{' '}
          <a href="https://aliciasykes.com" class="link link-primary">
            Alicia Sykes
          </a>
        ...
        <br />
        <p>
          For a more open source apps I've published, see{' '}
          <a href="https://apps.aliciasykes.com/" class="link link-primary">
            apps.aliciasykes.com
          </a>
          , or{' '}
          <a href="https://github.com/lissy93" class="link link-primary">
            follow me on GitHub
          </a>
        </p>
      </article>
      ...
      <article class="bg-back p-8 mx-auto max-w-[1200px] m-8 rounded-lg shadow-md">
        ...
        <p>
          This project is split-licensed, with the checklist content (located in{' '}
          <a
            class="link"
            href="https://github.com/Lissy93/personal-security-checklist/blob/HEAD/personal-security-checklist.yml"
          >
          ...
          . And everything else (including all the code), licensed under{' '}
          <b>
            <a href="https://gist.github.com/Lissy93/143d2ee01ccc5c052a17">MIT</a>
          </b>
          .
        </p>
        <pre class="bg-front whitespace-break-spaces rounded-sm text-xs my-2 mx-auto p-2">{license}</pre>
        <details class="collapse">
          ...
          <div class="collapse-content">
            <p class="mb-2">
              This means that for everything (except the checklist YAML file), you have almost unlimited freedom to use,
              copy, modify, merge, publish, distribute, sublicense, and/or sell copies of this software. All that we ask
              is that you include the original copyright notice and permission notice in any copies of the software
            </p>
            <p class="mb-2">
              And for the security-list content you can share and adapt this content as long as you give appropriate
              credit, don't use it for commercial purposes, and distribute your contributions under the same license.
            </p>
          </div>
        </details>
      </article>
  ...
  meta: [
    {
      name: 'description',
      content:
        'This project aims to give you practical guidance on how to improve your digital security, and protect your privacy online',
    },
  ],
};
