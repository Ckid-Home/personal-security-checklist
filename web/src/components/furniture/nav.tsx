        ...
        <div class="flex-none hidden md:flex items-center">
          <ul class="menu menu-horizontal px-1">
            ...
            <li>
              ...
              >
                <Icon icon="github" width={16} height={16} />
                GitHub
              </a>
            </li>
          </ul>
                ...
                <ul>
                  ...
                  <li class="flex flex-row">
                    <a href="https://github.com/lissy93">
                      <Icon icon="hub" width={16} height={16} />
                    </a>
                    <a href="https://x.com/lissy_sykes">
                      <Icon icon="twitter" width={16} height={16} />
                    </a>
                    <a href="https://mastodon.social/@lissy93">
                      <Icon icon="mastodon" width={16} height={16} />
                    </a>
                    <a href="https://dev.to/lissy93">
                      <Icon icon="dev" width={16} height={16} />
                    </a>
                    <a href="https://linkedin.com/in/aliciasykes">
            ...
            <div class="flex items-between w-full justify-between">
              ...
              >
                ...
                {themes.map((someTheme) => (
                  <option key={someTheme} value={someTheme} selected={someTheme === theme.theme}>
